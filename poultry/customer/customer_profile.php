...
$result = $conn->query("SELECT * FROM customer WHERE id = $user_id");

if ($result && $result->num_rows > 0) {
    $user = $result->fetch_assoc();
} else {
    $user = null; // fallback if user not found
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="profile-card">
        <form method="POST" enctype="multipart/form-data" action="process.php">
            <div class="mb-4 text-center">
                <img src="uploads/<?php echo htmlspecialchars($user['pic'] ?? 'customer.png'); ?>" alt="Profile Picture" class="rounded-circle profile-pic mb-3">
